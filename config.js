...
for (let i = 0; i < ownerlist.length; i += 2) {
    const owner = [
        ownerlist[i],            
        ownerlist[i +400755638523],         
        true                        
    ];
    global.owner.push(kiki);
}

//💌------------------------------------------💌


//💌global.pairingNumber = "0755638523" //put your bot number here💌
global.mods = ['0755638523'] 
global.prems = ['0755638523']
global.allowed = ['0755638523']
...
global.princebot = '🛡️bot-kiki-v3🛡️'
global.packname = 'kiki♥️' 
global.author = 'kiki♥️' 
